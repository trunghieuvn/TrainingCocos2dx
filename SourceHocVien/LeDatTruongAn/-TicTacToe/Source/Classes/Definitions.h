...
#define SPLASH_SCENE_BACKGROUND_FILEPATH "res/HelloWorld.png"
#define SPLASH_SCENE_SHOW_TIME 2.0
#define SCENE_TRANSITION_TIME 0.6f
...
#define TAG_PLAY_BUTTON 0
#define TAG_ACHIEVEMENTS_BUTTON 1

#define GAME_BACKGROUND_FILEPATH "res/blank.png"
